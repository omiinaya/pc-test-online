...
This guide establishes the BEM (Block Element Modifier) methodology as the standard CSS naming
convention for the MMIT Lab project. BEM provides a structured, maintainable approach to CSS that
eliminates specificity conflicts and improves code clarity.
