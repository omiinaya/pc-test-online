 ...
 */
const createIcon = (paths: (string | IconPath)[], props: IconProps = {}): IconComponent => {
  return (iconProps: IconProps = {}): VNode => {
...
export interface UseIconsReturn {
  /** @ignore */
  getIcon: (iconName: IconName, props?: IconProps) => VNode | null;
  /** @ignore */
  createIconWithProps: (iconName: IconName, defaultProps?: IconProps) => (props?: IconProps) => VNode | null;
  // Export individual icons for direct use
  /** @ignore */
  AlertTriangleIcon: IconComponent;
  /** @ignore */
  AlertCircleIcon: IconComponent;
  /** @ignore */
  XCircleIcon: IconComponent;
  /** @ignore */
  CheckCircleIcon: IconComponent;
  /** @ignore */
  ...
  /** @ignore */
  UnlockIcon: IconComponent;
  /** @ignore */
  CameraIcon: IconComponent;
  /** @ignore */
  MicIcon: IconComponent;
  /** @ignore */
  SpeakerIcon: IconComponent;
  /** @ignore */
  ArrowUpIcon: IconComponent;
  /** @ignore */
  ArrowDownIcon: IconComponent;
  /** @ignore */
  ArrowRightIcon: IconComponent;
  /** @ignore */
  RefreshIcon: IconComponent;
  /** @ignore */
  PlayIcon: IconComponent;
  /** @ignore */
  PauseIcon: IconComponent;
  /** @ignore */
  InfoIcon: IconComponent;
  /** @ignore */
  SettingsIcon: IconComponent;
}
...
export function useIcons(): UseIconsReturn {
   ...
   */
  const getIcon = (iconName: IconName, props: IconProps = {}): VNode | null => {
   ...
   * @ignore
   */
  const createIconWithProps = (iconName: IconName, defaultProps: IconProps = {}): ((props?: IconProps) => VNode | null) => {
    return (props: IconProps = {}): VNode | null => getIcon(iconName, { ...defaultProps, ...props });
  };
