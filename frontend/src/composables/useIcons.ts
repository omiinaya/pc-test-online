...
interface IconPath {
    ...
    children?: (string | VNode | undefined)[] | string | VNode | undefined;
}
...
export function useIcons(): UseIconsReturn {
     ...
     * @ignore
     */
    const createIconWithProps = (
        iconName: IconName,
        defaultProps: IconProps = {}
    ): ((props?: IconProps) => VNode | null) => {
        return (props: IconProps = {}): VNode | null =>
            getIcon(iconName, { ...defaultProps, ...props });
    };
