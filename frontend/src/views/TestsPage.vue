...
<template>
    <div class="app-layout">
        ...
        <div class="floating-action-buttons">
            ...
            <div class="export-menu-floating">
                <button
...
.floating-action-buttons {
    ...
    align-items: center;
    gap: 0.75rem;
    z-index: 999; /* Below footer but above content */
}
...
.floating-btn.export-btn:hover:not(.disabled) {
    background: rgba(255, 107, 0, 0.3);
    border-color: rgba(255, 107, 0, 0.5);
}

.floating-btn.export-btn.disabled {
...
.floating-btn.export-btn.disabled:hover {
    transform: none;
    box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);
}
...
.export-option-floating:hover {
    background: rgba(255, 255, 255, 0.1);
}

.export-option-floating .export-icon {
    flex-shrink: 0;
    opacity: 0.8;
}
