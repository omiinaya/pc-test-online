...
export default {
    ...
    computed: {
        showAction() {
            return this.showRetryButton || this.showActionButton || this.$slots.actions;
        },
        iconClass() {
            return {
                'icon-error': this.state === 'error',
                'icon-success': this.state === 'success',
                'icon-warning': this.state === 'warning',
                'icon-info': this.state === 'info',
                'icon-loading': this.state === 'loading',
                'icon-permission': this.state === 'permission',
            };
        },
    },
};
